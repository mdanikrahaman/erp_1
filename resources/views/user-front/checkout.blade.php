                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="field-input">
                                        <input type="text" class="form_control"
                                            placeholder="{{ $keywords['first_name'] ?? 'First Name' }}" name="billing_fname"
                                                ...
                                                <tr>
                                                    <td colspan="2" class="product-column">
                                                        <div class="column-box">
                                                            ...
                                                            <strong> {{ $keywords['Item_price'] ?? __('Item Price') }}: </strong>
                                                            <span dir="ltr">
                                                                {{ $userBs->base_currency_symbol_position == 'left' ? $userBs->base_currency_symbol : '' }}
                                                                {{ $item['product_price'] }}
                                                                {{ $userBs->base_currency_symbol_position == 'right' ? $userBs->base_currency_symbol : '' }}
                                ...
                                <div id="cartTotal">
                                    <ul class="cart-total-table">
                                        ...
                                        <li class="clearfix">
                                            ...
                                            <span
                                                class="col" dir="ltr">{{ $userBs->base_currency_symbol_position == 'left' ? $userBs->base_currency_symbol : '' }}<span
                                                    id="discount"
