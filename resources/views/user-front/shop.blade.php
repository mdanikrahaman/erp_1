...
@section('content')
                        ...
                        <div class="widget product-filter-widget">
                            ...
                            <div class="range">
                                <input type="text" min="0"
                                    value="{{ $userBs->base_currency_symbol_position == 'left' ? $userBs->base_currency_symbol : '' }}{{ request()->input('minprice') ?: $min_price }}{{ $userBs->base_currency_symbol_position == 'right' ? $userBs->base_currency_symbol : '' }}"
                                    name="minprice" id="amount1" readonly />
                                <input type="text" min="0"
                                    value="{{ $userBs->base_currency_symbol_position == 'left' ? $userBs->base_currency_symbol : '' }}{{ request()->input('maxprice') ?: $max_price }}{{ $userBs->base_currency_symbol_position == 'right' ? $userBs->base_currency_symbol : '' }}"
    ...
    <form id="searchForm" class="d-none" action="{{ route('front.user.shop', getParam()) }}" method="get">
        ...
        <input type="hidden" name="category" value="{{ !empty(request()->input('category')) ? request()->input('category') : null }}">
        <input type="hidden" name="subcategory" value="{{ !empty(request()->input('subcategory')) ? request()->input('subcategory') : null }}">
