                    ...
                    <div class="job-details-wrapper">
                        <div class="job-details">
                            ...
                            <div class="info">
                                ...
                                <div class="desc text-dark">{{$job->vacancy < 10 ? '0'.$job->vacancy : $job->vacancy}}</div>
                            </div>
                            @if (!empty($job->job_responsibilities))
                            <div class="info">
                                <strong class="label">{{$keywords['Job_Responsibilities'] ?? 'Job Responsibilities'}}</strong>
                            ...
                            <div class="info">
                                <strong class="label">{{$keywords['Educational_Requirements'] ?? 'Educational Requirements'}}</strong>
                                <div class="desc summernote-content">
                            ...
                            <div class="info">
                                <strong class="label">{{$keywords['Experience_Requirements'] ?? 'Experience Requirements'}}</strong>
                                <div class="desc summernote-content">
                            ...
                            <div class="info">
                                <strong class="label">{{$keywords['Additional_Requirements'] ?? 'Additional Requirements'}}</strong>
                                <div class="desc summernote-content">
                            ...
                            <div class="info">
                                <strong class="label">{{$keywords['Compensation_&_Other_Benefits'] ?? 'Compensation & Other Benefits'}}</strong>
                                <div class="desc summernote-content">
                            ...
                            <div class="info">
                                <strong class="label">{{$keywords['Read_Before_Apply'] ?? 'Read Before Apply'}}</strong>
                                <div class="desc summernote-content">
                            ...
                            <div class="info">
                                ...
                                <div class="desc">
                                    {{$keywords['Send your CV to'] ?? 'Send your CV to'}} <strong class="color-primary">{{$job->email}}</strong>.
                                </div>
                            </div>
                        </div>
                        <div class="post-footer d-md-flex align-items-md-center justify-content-md-between">
                            <div class="post-share">
                                <ul class="d-flex align-items-center">
                                    ...
                                    <li><a href="//www.linkedin.com/shareArticle?mini=true&amp;url={{urlencode(url()->current()) }}&amp;title={{convertUtf8($job->title)}}"><i class="fab fa-linkedin-in mr-2"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
