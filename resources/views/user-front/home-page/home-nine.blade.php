                        ...
                        <div class="single-hero-slide bg-img-center d-flex align-items-center text-center lazy"
                            ...
                            <div class="container">
                                <div class="slider-text">
                                    ...
                                    <a class="btn filled-btn" href="{{ $slider->btn_url }}" data-animation="fadeInUp"
                                        data-delay=".9s"> {{ $slider->btn_name }}
            ...
            @else
                <div class="single-hero-slide bg-img-center d-flex align-items-center text-center lazy"
                    ...
                    <div class="container">
                        <div class="slider-text">
                            <span class="small-text" data-animation="fadeInDown"
                                data-delay=".3s">{{ __('Welcome to Hotelia') }}</span>
            ...
            <div class="container">
                <div class="booking-form-wrap bg-img-center section-bg">
                    ...
                    <div class="booking-shape-1">
                        <img class="lazy" data-src=" {{ asset('assets/front/img/theme9/') }}/shape/01.png"
                            alt="shape">
                    </div>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="section-title">
                                        @isset($home_text->rooms_section_title)
                                            <span
                                                class="title-top with-border">{{ convertUtf8($home_text->rooms_section_title) }}</span>
                    @endif
                                            ...
                                            <div class="single-room">
                                                ...
                                                <div class="room-desc">
                                                    @if ($roomSetting->room_category_status == 1)
                                                        <div class="room-cat">
                                                            <a class="d-block p-0"
                                                                href="{{ route('front.user.rooms', ['username' => getParam(), 'category' => $room->id]) }}">{{ $room->roomCategory->name }}
                                                            </a>
                                                        </div>
                                                    @endif
                                                    <h4>
                                                        ...
                                                        <div class="feature-left">
                                                            <div class="section-title">
                                                                @isset($home_text->why_choose_us_section_title)
                                                                    <span
                                                                        class="title-top with-border">{{ $home_text->why_choose_us_section_title }}</span>
                                        @endif
