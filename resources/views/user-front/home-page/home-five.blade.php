                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-6 col-md-10">
                            <div class="feature-images row align-items-center content-mb-md-50">
                                <div class="col-md-12">
                                    <img data-src="{{ isset($home_text->work_process_section_img) ? asset('assets/front/img/work_process/' . $home_text->work_process_section_img) : asset('assets/front/img/feature-1.jpg') }}"
                        ...
                        <div class="consultation-form-area">
                            <div class="consultation-form">
                                ...
                                <form action="{{ route('front.contact.message', getParam()) }}" method="POST"
                                    ...
                                    <div class="input-field">
                                        <button type="submit"
                                            class="template-btn">{{ $keywords['Send_Message'] ?? 'Send Message' }} <i
                                ...
                                <div class="testimonial-item">
                                    ...
                                    <div class="author">
                                        ...
                                        <div class="author-info">
                                            ...
                                            <span
                                                class="title">{{ convertUtf8($testimonial->occupation) ?? null }}</span>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
