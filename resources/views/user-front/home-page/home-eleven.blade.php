                                        ...
                                        <div class="work-meta">
                                            <span class="mission">{{ $keywords['goal'] . ':' ?? __('Goal') . ':' }}
                                                ...
                                                @if ($userBs->base_currency_symbol_position == 'left')
                                                    {{ $userBs->base_currency_symbol . $cause->goal_amount }}
                                                @elseif($userBs->base_currency_symbol_position == 'right')
                                                    {{ $cause->goal_amount . $userBs->base_currency_symbol }}
                                                @endif
                                            </span>
                                            <span class="goal">{{ $keywords['raised'] . ':' ?? __('Raised') . ':' }}
                                                @if ($userBs->base_currency_symbol_position == 'left')
                                                    {{ $userBs->base_currency_symbol . $cause->raised_amount }}
                                                @elseif($userBs->base_currency_symbol_position == 'right')
                                                    {{ $cause->raised_amount . $userBs->base_currency_symbol }}
                                                @endif
