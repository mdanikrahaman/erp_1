                    ...
                    <div class="col-lg-6">
                        <div class="product-summary">
                            ...
                            {{ $userBs->base_currency_symbol_position == 'left' ? $userBs->base_currency_symbol : '' }}<span
                                class="price">{{ $n_price_d }}</span>{{ $userBs->base_currency_symbol_position == 'right' ? $userBs->base_currency_symbol : '' }}

                            @if ($isFlash)
                                <span class="previous-price">
                                    {{ $userBs->base_currency_symbol_position == 'left' ? $userBs->base_currency_symbol : '' }}<span>{{ $ad_details->item->current_price }}</span>{{ $userBs->base_currency_symbol_position == 'right' ? $userBs->base_currency_symbol : '' }}
                                </span>
                            @elseif($ad_details->item->previous_price > 0)
                                <span class="previous-price">
                                    {{ $userBs->base_currency_symbol_position == 'left' ? $userBs->base_currency_symbol : '' }}<span>{{ $ad_details->item->previous_price }}</span>{{ $userBs->base_currency_symbol_position == 'right' ? $userBs->base_currency_symbol : '' }}
                                </span>
                            @endif
                            ...
                            @if ($ad_details->item->sku)
                                <div class="sku mb-2">
                                    <span class="d-inline-block">{{ __('SKU') }} :</span> <strong>{{ $ad_details->item->sku }}</strong>
                                </div>
                            @endif
