                ...
                <div class="card-body pt-5 pb-5">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form id="ajaxForm" class="" action="{{ route('user.vcard.store') }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <p class="text-warning mb-0">Use this name to identify sepcific vcard from your
                                                vcards list.</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <p class="text-warning mb-0">Enter Phone Number with <strong
                                                    class="text-danger">Country Code</strong></p>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control ltr" name="website_url" value=""
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <button class="btn btn-primary" @click="addInformation">Add
                                                    Information</button>
                                            </div>
                                        </div>
                                    </div>
