    ...
    <script>
        $(document).ready(function() {
            ...
            var addItem = function(key) {
                ...
                rpItemNode += `<div class="col-lg-2" ><button class="btn btn-danger btn-sm js-repeater-remove mb-2 mr-2" type="button"
                                        onclick="$(this).parents('.js-repeater-item').remove()">X</button>
                                <button class="btn btn-success btn-sm js-repeater-child-add mb-2" type="button" data-it="${it}">Add Option</button> </div>
