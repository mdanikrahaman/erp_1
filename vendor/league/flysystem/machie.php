    ...
    ******************* User Routes *************************
    ...
    Route::group(['prefix' => 'user', 'middleware' => ['auth', 'userstatus']], function () {
        ...
        Route::group(['middleware' => 'checkUserPermission:Ecommerce|Donation Management|Course Management|Hotel Booking'], function () {
            ...
            Route::post('/secrect-login', 'User\UserController@secretLogin')->name('customer.secrect.login');
...
Route::group(['domain' => $domain, 'prefix' => $prefix], function () {
    ...
    Route::group(['middleware' => ['routeAccess:Hotel Booking']], function () {
    ...
    Route::group(['middleware' => ['routeAccess:Course Management']], function () {
    ...
    Route::group(['middleware' => ['routeAccess:Donation Management']], function () {
    ...
    Route::prefix('/customer')->middleware(['auth:customer', 'accountStatus', 'checkWebsiteOwner', 'routeAccess:Ecommerce|Hotel Booking|Course Management|Donation Management'])->group(function () {
    ...
    Route::group(['middleware' => ['routeAccess:Ecommerce']], function () {
        ...
        Route::post('product/review/submit', 'Front\ReviewController@reviewsubmit')->name('item.review.submit');
