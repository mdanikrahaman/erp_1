...
class PaypalController extends Controller
{
    ...
    public function paymentProcess(Request $request, $_amount, $_title, $_success_url, $_cancel_url)
    {
        ...
        if ($currencyInfo->base_currency_text !== 'USD') {
            ...
            $convertedTotal = $request['total'] / $rate;
        }

        $price =  $currencyInfo->base_currency_text === 'USD' ? $request['total'] : $convertedTotal;
    ...
    public function successPayment(Request $request)
    {
        ...
        if ($requestData['title'] == "Hotel Room Booking") {
        ...
        if ($result->getState() == 'approved') {
            ...
            if ($requestData['title'] == "Room Booking") {
